...
public class DateTimeUtils {
     ...
     */
    public static String getCurSysYYYYMMDD() {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println("YYYYMMDD:"+getCurSysYYYYMMDD());


        int i = daysBetween(new Date(), new Date());
